...
export default function LeaderboardSection({ data }) {
  return (
    <div className="flex items-end justify-center mb-8 pt-[20px] mb-[180px]">
      <div className="flex items-end justify-center w-full">
        ...
        <div className="flex flex-col items-center w-[125px]">
          ...
          <div className="text-[14px] font-bold archivo-font text-center mb-2 text-white w-[200px]">
            {data[1].name}
          </div>
          <div className="relative">
            ...
            <div className="absolute left-1/2 bottom-[-116px] -translate-x-1/2 w-[108px] pl-[4px] text-left">
              ...
              <div className="text-[16px] text-white font-bold mb-1 archivo-font break-words w-[108px]">
                {data[1].song}
              </div>
              <div
        ...
        <div className="flex flex-col items-center w-[125px]">
          <div
            className="text-[#E1A224] text-[24px] font-black archivo-font"
            style={{ fontStyle: "italic" }}
          >
            #1
          </div>
          <Avatar className="w-20 h-20 mb-2 border-2 border-white">
            <AvatarFallback className="bg-[#4A4A4A]">MS</AvatarFallback>
          </Avatar>
          <div className="text-[14px] font-bold archivo-font text-center mb-2 text-white w-[200px]">
            {data[0].name}
          </div>
          <div className="relative">
            ...
            <div className="absolute left-1/2 bottom-[88px] -translate-x-1/2 bg-[rgba(72,72,72,0.50)] rounded-[10px] flex justify-center items-center py-[8px] shadow-lg w-[104px]">
              <div className="flex items-center justify-center gap-1 w-full">
                <img
                  ...
                  style={{
                    filter:
                      "brightness(0) saturate(100%) invert(91%) sepia(31%) saturate(3592%) hue-rotate(331deg) brightness(100%) contrast(106%)",
                  }}
                />
                <span className="text-[#FFC628] text-[20px] archivo-font font-bold">
            ...
            {/* Podium*/}
            <div className="p-[3px] rounded-t-[13px] bg-gradient-to-b from-[#793FEF] to-[#E86842]">
              <div className="w-20 h-[280px] bg-gradient-to-b from-[#A173FF] to-[#D49684] rounded-t-[12px] flex items-end justify-center pb-2"></div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center w-[125px]">
          <div
            className="text-[#D48C35] text-[24px] font-black archivo-font"
            style={{ fontStyle: "italic" }}
          >
            #3
          </div>
          <Avatar className="w-16 h-16 mb-2 border-2 border-white">
            <AvatarFallback className="bg-[#4A4A4A]">YS</AvatarFallback>
          </Avatar>
          <div className="text-[14px] font-bold archivo-font text-center mb-2 text-white w-[200px]">
            {data[2].name}
          </div>
          <div className="relative">
            ...
            <div className="absolute left-1/2 bottom-[88px] -translate-x-1/2 bg-[rgba(72,72,72,0.50)] rounded-[10px] flex justify-center items-center py-[8px] shadow-lg w-[104px]">
              <div className="flex items-center justify-center gap-1 w-full">
                <img
                  ...
                  style={{
                    filter:
                      "brightness(0) saturate(100%) invert(62%) sepia(49%) saturate(729%) hue-rotate(348deg) brightness(92%) contrast(80%)",
                  }}
                />
                <span className="text-[#D48C35] text-[20px] archivo-font font-bold">
                  {data[2].score.toLocaleString()}
                </span>
              </div>
            </div>
            {/* Album Cover */}
            ...
            <div className="absolute left-1/2 bottom-[-116px] -translate-x-1/2 w-[108px] pl-[4px] text-left">
              <div
                className="text-[12px] text-[#A8A8A8] mb-1 archivo-font pt-[4px]"
                style={{ fontStyle: "italic" }}
              >
                Top Track
              </div>
            ...
            {/* Podium*/}
            <div className="p-[3px] rounded-t-[13px] bg-gradient-to-b from-[#793FEF] to-[#E86842]">
              <div className="w-20 h-[180px] bg-gradient-to-b from-[#A173FF] to-[#D49684] rounded-t-[12px] flex items-end justify-center pb-2"></div>
            </div>
          </div>
        </div>
      </div>
